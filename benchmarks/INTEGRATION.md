...
- Gallery wall time rises substantially with the expanded parity renderer/gallery workload and imports. This is a real command-level regression, but the old and new gallery do not perform identical rendering work; it is not evidence that the lazy help path regressed.
